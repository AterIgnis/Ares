...
class CfgVehicles
{
	...
	class Ares_Artillery_Module_Base : Ares_Module_Base
	{
	...
	class Ares_Drones_Module_Base : Ares_Module_Base
	{
		subCategory = "Drones";
	};
	...
	#include "cfgVehiclesModulesArtillery.hpp"
	#include "cfgVehiclesModulesBehaviours.hpp"
	#include "cfgVehiclesModulesDrones.hpp"
