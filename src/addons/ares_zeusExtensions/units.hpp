...
units[] =
{
	...
	"Ares_Module_Equipment_ConfigurePylons",
	"Ares_Module_Equipment_Lights",
	"Ares_Module_Equipment_Nvgs",
	"Ares_Module_Equipment_SetAmmoPercent",
	...
	"Ares_Module_Reinforcements_Spawn_Garrison",
	...
	"Ares_Module_Util_IncarnatePlayer",
	"Ares_Module_Util_UninjurePlayer",
	"Ares_Module_Util_DisableSimulation",
	"Ares_Module_Util_EnableSimulation",
	"Ares_Module_Util_DisableDebugLog",
	"Ares_Module_Util_EnableDebugLog",
	"Ares_Module_Util_ChangePlayerSides",
	"Ares_Module_Util_ExecuteCodeAll",
	"Ares_Module_Util_ExecuteCodeLocal",
	"Ares_Module_Util_ExecuteCodeServer",
	"Ares_Module_Artillery_Battery",
	"Ares_Module_Artillery_Fire",
	"Ares_Module_Artillery_Fire_Side_Blue",
	"Ares_Module_Artillery_Fire_Side_Red",
	"Ares_Module_Artillery_Fire_Side_Guer",
	"Ares_Module_Artillery_Fire_Side_Civ",
	"Ares_Module_Drones_Fire_On_Mark",
	"Ares_Module_Drones_Track",
	"Ares_Module_Drones_TrackBy",
